...
Nova.booting(function (Vue, router, store) {
  Vue.component('ForbiddenWordsCard', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        toggleIsActive: function toggleIsActive(index) {
      ...
      _c("card", { staticClass: "flex flex-col items-center justify-center" }, [
        _c("div", { staticClass: "px-3 py-3" }, [
          _c("h1", { staticClass: "text-center text-3xl text-80 font-light" }, [
            _vm._v("Forbidden words")
          ])
        ])
      ]),
      _vm._v(" "),
      _c("card", { staticClass: "flex flex-col items-center justify-center" }, [
        _c("div", { staticClass: "flex flex-row items-start justify-center" }, [
          _c("input", {
            directives: [
              {
                name: "model",
      ...
      _c("card", { staticClass: "flex flex-col items-center justify-center" }, [
        _c(
          ...
          _vm._l(_vm.words, function(word, index) {
            return _c("div", { key: "word._id", staticClass: "m-3" }, [
              _c("input", {
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.words[index].isActive,
                    expression: "words[index].isActive"
                  }
                ],
                attrs: { type: "checkbox", id: "word._id" },
                domProps: {
                  checked: word.isActive,
                  checked: Array.isArray(_vm.words[index].isActive)
                    ? _vm._i(_vm.words[index].isActive, null) > -1
                    : _vm.words[index].isActive
                },
                on: {
                  change: [
                    function($event) {
                      var $$a = _vm.words[index].isActive,
                        $$el = $event.target,
                      ...
                      if (Array.isArray($$a)) {
                        ...
                        _vm.$set(_vm.words[index], "isActive", $$c)
                      }
                    },
                    function($event) {
                      return _vm.toggleIsActive(index)
                    }
                  ]
                }
              }),
              _vm._v(" "),
              _c("label", { attrs: { for: "word._id" } }, [
