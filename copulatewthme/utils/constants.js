...
const subscriptionPlans = [
  {
    _id: 1,
    icon: <img src="/img/plans/icon-standart.svg" />,
    type: 'Free',
    title: 'Standard',
    price: 'Free',
    direction: null,
  ...
  },
  {
    ...
    buttonColor: 'linear-gradient(272.87deg, #E6D197 -45.12%, #FAF5BD -45.12%, #E8D696 -17.31%, #CDB575 16.66%, #D0B26B 49.43%, #D0AB5E 85.36%, #C1913D 161.79%)',
    activeColor: '#C1913D',
  },
]
