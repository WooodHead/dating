...
function IconMobileMenu(
  ...
  const isOpen = useSelector(windowActions.selectors.asideIsOpen);
  
  return (
    <div className={className} onClick={() => {
      !isOpen ? bodyOverflow(mediaSizes.lg) : cancelOverflow();
      dispatch(windowActions.actions.TOGGLE_ASIDE(!isOpen));
    }}>
      {!isOpen ? (
