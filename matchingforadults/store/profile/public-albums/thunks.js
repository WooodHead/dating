...
const getPublicAlbums = createAsyncThunk('profile/public-albums', async ({ userId }, { getState }) => {
  try {
...
const getPublicAlbumInfo = createAsyncThunk('profile/public-album-info', async (albumId) => {
  try {
