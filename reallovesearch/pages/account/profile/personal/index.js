...
import PersonalPhotoAlbums from "components/AccountPage/PersonalPhotoAlbums";
...
function Personal() {
  ...
  return (
    userLoaded ? (
      ...
      >
        <PersonalAboutMyself control={control} getValues={getValues} setValue={setValue} watch={watch}/>
