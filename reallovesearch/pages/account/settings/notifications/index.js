...
import { defaultValues, schema } from "configs/account/settings/notifications";
...
NotificationsPage.layouts = [MainLayout, AccountProfileLayout];
...
function NotificationsPage() {
  ...
  return (
    ...
    >
      <div className="text-xl text-uppercase text-poppins text-medium color-blue-900 mb-5">
