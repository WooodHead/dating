...
function BuyingSubscription() {
  ...
  return (
    <>
      <div className="title-md text-medium text-center mb-2 mt-3 color-blue-900">
        Buying a subscription
      </div>
      <div className={cn(styles.subtitle, 'text-md text-medium text-center color-blue-900')}>
