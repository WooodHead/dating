...
const selectors = {
  ...
  formattedEnums: state => {
    ...
    return {
      ...
      diet: prepareSelectOptions(additionalData?.diet),
      smoke: prepareSelectOptions(additionalData?.smoke),
      alcohol: prepareSelectOptions(additionalData?.alcohol),
      preference: prepareRadioOptions(additionalData?.preference),
    }
  },
